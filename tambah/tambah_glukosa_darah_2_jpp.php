...
<head>
    ...
    <title>Tambah Glukosa Darah 2 JPP</title>
...
<div class="container mt-4">
    <div class="shadow p-3 mb-4 bg-white rounded">
        <h5><b>Selamat Datang Di Halaman Tambah Data Glukosa Darah 2 JPP</b></h5>
    </div>
    ...
    <form action="" method="POST">
        <div class="card shadow bg-white">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Glukosa Darah 2 JPP (mg/dL) :</label>
                    <div class="col-sm-9">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-md-1 text-right">
                        <a href="index.php?halaman=glukosa_2_jpp" class="btn btn-danger">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    // Fungsi untuk menghitung analisis glukosa darah 2 JPP
    $('#hitung').click(function() {
        ...
        } else if (glukosa >= 80 && glukosa <= 140) {
