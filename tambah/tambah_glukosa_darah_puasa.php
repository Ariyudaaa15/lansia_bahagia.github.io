...
<head>
    ...
    <title>Tambah Glukosa Darah Puasa</title>
...
<div class="container mt-4">
    <div class="shadow p-3 mb-4 bg-white rounded">
        <h5><b>Selamat Datang Di Halaman Tambah Data Glukosa Darah Puasa</b></h5>
    </div>
    ...
    <form action="" method="POST">
        <div class="card shadow bg-white">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Glukosa Darah Puasa (mg/dL) :</label>
                    <div class="col-sm-9">
                        <input type="number" id="glukosa_darah_puasa" name="glukosa_darah_puasa" class="form-control" placeholder="Masukan Nilai Glukosa Darah Puasa" required>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-md-1 text-right">
                        <a href="index.php?halaman=glukosa_darah_puasa" class="btn btn-danger">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    // Fungsi untuk menghitung hasil glukosa darah puasa dan memberikan rekomendasi
    $('#hitung').click(function() {
        const glukosa = parseFloat($('#glukosa_darah_puasa').val());
        let hasil = '';
        let rekomendasi = '';

        // Menghitung hasil berdasarkan nilai glukosa darah puasa
        if (glukosa < 70) {
            hasil = 'Glukosa Darah Puasa Rendah';
            rekomendasi = 'Rekomendasi: Perbaiki pola makan dan asupan gizi.';
        } else if (glukosa >= 70 && glukosa <= 100) {
            hasil = 'Glukosa Darah Puasa Normal';
            rekomendasi = 'Rekomendasi: Tidak ada tindakan khusus diperlukan.';
        } else if (glukosa > 100) {
            hasil = 'Glukosa Darah Puasa Tinggi';
            rekomendasi = 'Rekomendasi: Rutin cek gula darah, konsultasi ke dokter, perbaiki pola makan, cukup istirahat.';
        }
