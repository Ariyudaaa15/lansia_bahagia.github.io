...
<head>
    ...
    <title>Tambah Kolesterol Darah</title>
...
<div class="container mt-4">
    <div class="shadow p-3 mb-4 bg-white rounded">
        <h5><b>Selamat Datang Di Halaman Tambah Data Kolesterol Darah</b></h5>
    </div>
    ...
    <form action="" method="POST">
        <div class="card shadow bg-white">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="id_lansia" id="id_lansia" class="form-control" onchange="getNamaLansia()" required>
                            ...
                            <?php
                            include '../koneksi/konek.php'; // Include koneksi database
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Kolesterol Darah (mg/dL) :</label>
                    <div class="col-sm-9">
                        <input type="number" id="kolesterol_darah" name="kolesterol_darah" class="form-control" placeholder="Masukkan Nilai Kolesterol Darah" required>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-md-1 text-right">
                        <a href="index.php?halaman=kolesterol" class="btn btn-danger">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    // Fungsi untuk menghitung analisis kolesterol darah
    $('#hitung').click(function() {
        const kolesterol = parseFloat($('#kolesterol_darah').val());
        let hasil = '';
        let rekomendasi = '';

        if (kolesterol < 200) {
            hasil = 'Kolesterol Darah Normal';
            rekomendasi = 'Rekomendasi: Tidak ada tindakan khusus diperlukan.';
        } else if (kolesterol >= 200 && kolesterol <= 239) {
            hasil = 'Kolesterol Darah Tinggi';
            rekomendasi = 'Rekomendasi: Perbaiki pola makan, tingkatkan aktivitas fisik, dan konsultasi ke dokter.';
        } else {
            hasil = 'Kolesterol Darah Sangat Tinggi';
            rekomendasi = 'Rekomendasi: Konsultasi dokter segera, perbaiki pola makan, dan pertimbangkan pengobatan.';
        }
